...
{
	$insData = $conn->query("INSERT INTO instructors_tbl (instructor_fullname,instructor_surname,instructor_middle,instructor_gender,instructor_bdate,instructor_email,instructor_pass,cou_id) VALUES('$fullname','$surname','$middle','$gender','$bdate','$email','$ins_password','$assign_course_array') ");
	if($insData)
	{
