...
?>
<input type="hidden" name="" class="sectionID" id="<?php echo $var;?>">
<div class="app-main__outer">
    ...
    <div class="app-main__inner">
            ...
            <div class="col-md-15">
                        <div class="table-responsive" style="padding-left: 15px; padding-right: 15px; padding-bottom: 15px; padding-top: 25px;">   ement</button></center> -->
                        <table width="100%" class="table table-hover" id="data-table">
                            <thead>
                            <tr>
                                <th class="text-center" width="80%">Announcement</th>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="media">     
                                                                ...
                                                                <div class="media-body ml-4">
                                                                    <div class="float-right text-muted small" id="<?php echo 'section'.$row->ann_id; ?>">Author: <span style="color: blue"><?php 
