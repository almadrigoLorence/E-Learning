...
<?php 
$lessId = $_GET['id'];
$selLesson = $conn->query("SELECT * FROM lessons_tbl WHERE lesson_id='$lessId' ")->fetch(PDO::FETCH_ASSOC);
?>
                        ...
                        <div class="app-page-title bg-premium-dark text-light">
                            <div class="page-title-wrapper ">
                                <div class="page-title-heading">
                                    ...
                                    <div>
                                        <?php echo $selLesson['lesson_title'] ;?>
                                        
                                        <div class="page-title-subheading">
                                            <nav class="" aria-label="breadcrumb">
                                                    <ol class="breadcrumb">
                                                        <li class="breadcrumb-item"><a href="home.php" style="color: white">Dashboard</a></li>
                                                        <li class="active breadcrumb-item" aria-current="page"><?php echo $selLesson['lesson_title']; ?></li>
                                                    </ol>
                                                </nav>
                                        </div>
                                    </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body py-3">
                                <div class="row no-gutters align-items-center">
                                    <div class="col">
                                        <span style="font-size: 19px;"><?php echo $selLesson['lesson_title'] ?></span>
