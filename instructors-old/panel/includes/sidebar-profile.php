<div class="app-sidebar sidebar-shadow bg-happy-green sidebar-text-dark" data-class="bg-happy-green sidebar-text-light">
              ...
              <!--   <li class="app-sidebar__heading">My Performance</li>
                ...
                <ul >
                    <?php 
                     ...
                     <li class="app-sidebar__heading">MY FILES  <span><div class="ml-auto badge badge-pill badge-secondary"> <?php echo $totalCourse = $selLes['totLes']; ?></div></span></li>
                     <li>
                     <a href="#">
                     <i class="metismenu-icon pe-7s-file"></i>
                     Uploaded Files
