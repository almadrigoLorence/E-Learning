            ...
            <div class="app-page-title bg-slick-carbon text-white">
                <div class="page-title-wrapper" >
                      <div class="page-title-heading">
                          <div class="page-title-icon"><img src="assets/images/quiz1.png" height="40" width="40"></div>
                            <div>Quizzes Section - Manage Long periodical quizs for differrent course and sections with GNED06 (STS)
                                <div class="page-title-subheading">
                                    <nav class="" aria-label="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="home.php?page=manage-quiz" style="color: white">Long quiz Table</a></li>
                                        <li class="active breadcrumb-item" aria-current="page" style="color: #3ac47d"><?php echo $selQuizRow['quiz_title']; ?></li>
                                        </ol>
                                    </nav> 
                                </div>
                            </div>
                           ...
                           <form method="post" id="updatequizFrm">
                               <div class="form-group">
                                <label><i class="pe-7s-study"></i> Course</label>
                                  ...
                                  <option value="<?php echo $selQuizRow['cou_id']; ?>"><?php echo $selCourse['courseName']; ?></option>
                                  <?php 
