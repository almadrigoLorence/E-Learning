<?php 
 ...
 else
 {
	...
	if($insAct)
	{
		...
		$datetoday = date("F d, Y - h:m:s a");
		$uniq = uniqid();
		$addnotif = $conn->query("INSERT INTO notification_tbl(not_desc,date_upload,uploader,cou_id,`uniqid`) VALUES('New Activity','$datetoday','admin','$courseSelected','$uniq')");
