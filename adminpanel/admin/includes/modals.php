...
<div class="modal fade" id="modalForAddTopic" tabindex="-1" role="dialog" aria-hidden="true" style="padding-top: 3%;">
  <div class="modal-dialog modal-lg" role="document">
   <form id="addTopicFrm" method="post" enctype="multipart/form-data">
     <div class="modal-content">
      <div class="modal-header bg-slick-carbon text-light">
               ...
               <div class="card-body">
                  ...
                  <label class="col-sm-2 col-form-label">Title</label>
                    ...
                    <label class="col-sm-2 col-form-label">Topic description</label>
                      <div class="col-sm-10">
                        <textarea name="topicDesc" class="form-control" rows="10" required=""></textarea>
                      </div>
                    </div>
                    <div class="position-relative row form-group">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div>
                <label>Description</label>
                 <textarea name="description" id="description" rows="500"></textarea>
            </div>
            <br>
            <div class="row">
              <div class="col-sm-4">
...
<!-- MODAL FOR ANNOUNCEMENT PREVIEW -->
<!-- <div class="modal fade bd-example-modal-lg" id="modalForViewAnnouncement" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
       <form class="refreshFrm" id="viewAnn" method="post">
        <div class="modal-content">
            <div class="modal-header">
                 <?php
                  $seAnn = $conn->query("SELECT * FROM announcement_tbl");
                   ?></h5>
                <h5 class="modal-title" id="exampleModalLongTitle">Announcement Title: <?php echo $row->ann_title;?>
