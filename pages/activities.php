                                            ...
                                            <table id="myTable" class="table table-inverse">
                                             <tbody>
                                                ...
                                                <tr>
                                                  <td>
                                                    <div class="row no-gutters align-items-left">
                                                        <div class="col-md-10">
                                                            <div class="text-muted small mt-1">Posted on &nbsp;·&nbsp; <?php echo $row->date_uploaded?></a></div>
                                                            <a href="home.php?page=activity&id=<?php echo $row->act_id; ?>" class="text-big" style="color: #3ac47d; font-size: 18px;">
                                                            ...
                                                            if ($row->act_file == '') {
                                                                ...
                                                                ?>
                                                                Attached File: <a href="query/downloadfileactivity.php?filename=<?php echo $row->act_file; ?>&foldername=<?php echo $row->uid ?>"><?php echo $row->act_file; ?></a>
                                              ...
                                              { ?>
                                                  <tr>
                                                    <td align="center">
                                                      <span class="text-muted small">Activity module is empty</span>
                                                    </td>
                                                  </tr>
                                                <?php 
                                            }
