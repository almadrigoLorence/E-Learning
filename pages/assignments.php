                            ...
                            <div class="page-title-wrapper">
                                <div class="page-title-heading">
                                    <div class="page-title-icon">
                                        <img src="assets/images/assignment.png" height="40" width="40">
                                    </div>
                                    <div>Assignments
                                        <div class="page-title-subheading">
                                            <nav class="" aria-label="breadcrumb">
                                                    <ol class="breadcrumb">
                                                        ...
                                                        <li class="active breadcrumb-item" aria-current="page">List of assignments</li>
                                                    </ol>
                                                </nav>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 text-muted">
                                        <div class="row no-gutters align-items-center">
                                             <div class="input-group">
                                                ...
                                                <input placeholder="Search assignment.." type="text" class="form-control" id="search_field">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table id="myTable" class="table table-inverse">
                                             ...
                                             <tbody>
                                                        ...
                                                        <div class="col-md-15">
                                                            ...
                                                            <div class="row no-gutters align-items-center">
                                                                <div class="media col-8 align-items-center">
                                                                    <div class="text-big pl-4" style="text-align: justify;"><?php echo $row->ass_desc ?></div>
                                                                    
                                                                </div>
                                                            </div>
                                                            <div class="text-muted small mt-1"><a href="javascript:void(0)" class="text-muted"><?php echo $row->date_uploaded?></a></div>
                                                        </div>
                                              ...
                                              { ?>
                                                  <tr>
                                                    <td align="center">
                                                      <span class="text-muted small">No current assignment</span>
                                                    </td>
                                                  </tr>
                                                <?php }
                                                ?>
