                                            ...
                                            <table id="myTable" class="table table-inverse">
                                             ...
                                             <tbody>
                                                  ...
                                                  <td> 
                                                        ...
                                                        <div class="col-8"><i class="pe-7s-clock"></i> <?php echo $selExamRow['ex_time_limit'];?> minutes</div>
                                                            <div class="media col-4 align-items-right">
                                                                <?php
                                                                $qid =  $selExamRow['ex_id'];
                                                                $myID = $_SESSION['examineeSession']['exmne_id'];
                                                                $selExamAttmpt = $conn->query("SELECT * FROM exam_attempt WHERE exmne_id='$myID' AND exam_id='$qid' ");

                                                                 if($selExamAttmpt->rowCount() > 0)
                                                                 {
                                                                    ?>
                                                                    <a href="home.php?page=result&id=<?php echo$qid?>" data-id="<?php echo $selQuizRow['quiz_id'];?>" class="btn btn-success"><i class="fa fa-bars"></i> View Result</a>
                                              ...
                                              { ?>
                                                  <tr>
                                                    <td colspan="5">
                                                      <h3 class="p-3">No Current Exam</h3>
                                                    </td>
                                                  </tr>
                                                <?php }
                                                ?>
