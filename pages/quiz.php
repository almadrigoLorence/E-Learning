...
<div class="app-main__inner">
                        ...
                        <div class="col-sm-3">
                            <div class="main-card db-3">
                                <div class="card-header text-light" style="background-color: #3ac47d">Menu</div>
                                    <div class="card-body">
                        ...
                        <div class="col-lg-9">
                            <div class="card-header pl-0 pr-2" style="background-color: #3ac47d">
                            </div>
                            <hr class="m-0">
                            <div class="card">
                                            <table id="myTable" class="table table-inverse">
                                             ...
                                             <tbody>
                                                ...
                                                <tr>
                                                  <td>
                                                            <div class="row no-gutters align-items-left">
                                                                <div class="col-md-12">
                                                                    <i class="pe-7s-pen"></i>
                                                                      <span style="font-size: 15px;"><?php echo $selQuizRow['quiz_title']; ?></span>
                                                  ...
                                                  <td> 
                                                        ...
                                                        <div class="col-8"><i class="pe-7s-clock"></i> <?php echo $selQuizRow['quiz_time_limit'];?> minutes</div>
                                                            ...
                                                            <?php
                                                            $qid = $selQuizRow['quiz_id'];
                                                            $myID = $_SESSION['examineeSession']['exmne_id'];
                                                              $selExamAttmpt = $conn->query("SELECT * FROM quiz_attempt WHERE exmne_id='$myID' AND quiz_id='$qid' ");

                                                                 if($selExamAttmpt->rowCount() > 0)
                                                                 {?>
                                                                    <a onclick="result('<?php echo $selQuizRow['quiz_id'];?>')" href="#" data-id="<?php echo $selQuizRow['quiz_id'];?>" class="btn btn-success"><i class="fa fa-bars"></i> View Result</a>
                                                                   <?php
                                                                 }
                                                                 else
                                                                 {?>
                                                                    <a href="#" id="startQuiz2" data-id="<?php echo $selQuizRow['quiz_id'];?>" class="btn btn-warning"><i class="fa fa-play-circle"></i> Start Quiz</a>
                                                                   <?php
                                                                 }
                                                            ?>
                                              ...
                                              { ?>
                                                  <tr>
                                                    <td align="center">
                                                      <span class="text-muted small">No quiz at the moment</span>
                                                    </td>
                                                  </tr>
                                                <?php }
                                                ?>
